...
public class FileUtility
{
     ...
     * @return whether the file was created
     */
    public static void createFile(String fullName, InputStream in) throws IOException {
    	FileConnection file = null;
        try {
            file = (FileConnection) Connector.open( fullName );
            writeFile(file, in);
    ...
    public static void writeFile (FileConnection fc, InputStream in) throws IOException {
        OutputStream fout = null;
        try {
            if (!fc.exists()) {
                fc.create();
            }
            fout = fc.openOutputStream();
