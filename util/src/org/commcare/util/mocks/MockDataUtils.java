...
public class MockDataUtils {
    ...
    public static MockUserDataSandbox getStaticStorage() {
        ...
        MockUserDataSandbox sandbox = new MockUserDataSandbox(factory);
        return sandbox;
    }
     ...
     * @return
     */
    public static FormInstance loadFixture(MockUserDataSandbox sandbox, String refId, String userId) {
