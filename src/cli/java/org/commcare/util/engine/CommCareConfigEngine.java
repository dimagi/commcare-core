...
public class CommCareConfigEngine {
     ...
     */
    public boolean attemptAppUpdate(String updateTarget, String username) throws InstallCancelledException, UnfullfilledRequirementsException, UnresolvedResourceException {
