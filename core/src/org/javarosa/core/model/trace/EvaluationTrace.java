...
/**
 * Captures details about the outcome of a "Step" of
 * expression execution, and its recursive subexpressions.
 * 
 * @author ctsims
 *
 */
public class EvaluationTrace {
    ...
    EvaluationTrace parent;
    Object value;
    String expression;
    
    Vector<EvaluationTrace> children = new Vector<EvaluationTrace>();
